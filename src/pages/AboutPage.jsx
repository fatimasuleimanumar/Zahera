  ...
  return (
    <div className="text-left bg-white text-gray-900 overflow-hidden">
      ...
      <section className="max-w-4xl mx-auto px-6 text-center pt-16 pb-14">
        <div className="inline-flex items-center gap-2 px-4 py-1 rounded-full bg-[#FFEBF2] text-[#D81B60] text-xs font-bold uppercase tracking-wider mb-5">
          <span>About Us</span>
        </div>
      ...
      <section className="max-w-[1380px] mx-auto px-3 sm:px-6 mb-24">
        <div className="bg-[#FFF5F8] rounded-[2.5rem] sm:rounded-[3.5rem] py-14 sm:py-20 px-6 sm:px-10 lg:px-16 border border-pink-100/80 shadow-xs">
          {/* Section Header Row */}
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mb-14">
            <div className="lg:col-span-6 space-y-3">
              <span className="inline-flex items-center px-3.5 py-1 rounded-full bg-white text-[#D81B60] text-xs font-bold uppercase tracking-wider shadow-xs">
                Why Choose Us
              </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-7 border border-pink-100 shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 flex flex-col justify-between group">
              <div>
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg sm:text-xl font-bold text-gray-900 group-hover:text-[#FF4288] transition-colors">
                    Clinical Obstetrics Grounding
                  </h3>
                  <span className="w-8 h-8 rounded-full bg-[#FFEBF2] text-[#FF4288] flex items-center justify-center font-bold text-sm shrink-0 group-hover:bg-[#FF4288] group-hover:text-white transition-colors">
                    ↗
                  </span>
                </div>
              ...
              <div className="w-full aspect-[16/10] rounded-2xl overflow-hidden bg-pink-50 border border-pink-100/60 mt-2">
            ...
            {/* Card 2: Dark Contrast Accent Card (100% Offline SQLite) */}
            <div className="bg-[#1A1118] text-white rounded-3xl p-6 sm:p-7 border border-purple-950/60 shadow-xl hover:shadow-2xl hover:-translate-y-1.5 transition-all duration-300 flex flex-col justify-between group">
              <div>
                <div className="flex items-center justify-between mb-4">
      ...
      {/* 3. Impact & Bento Metrics Section ("Expertise You Can Count On") */}
      <section className="max-w-7xl mx-auto px-6 mb-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-end mb-12">
          <div className="lg:col-span-7 space-y-3">
            <span className="inline-flex items-center px-3.5 py-1 rounded-full bg-[#FFEBF2] text-[#D81B60] text-xs font-bold uppercase tracking-wider">
              Proven Impact
            </span>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 tracking-tight leading-tight">
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <div className="flex items-center gap-3">
              <a href="https://forms.gle/QRuTUvbqB3L2rk5e6" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-[#FF4288] hover:bg-[#E03375] text-white text-xs sm:text-sm font-bold shadow-md shadow-pink-500/25 transition-all">
                <span>Join Pilot Waitlist</span>
                <span>↗</span>
              </a>
              <button onClick={() => setCurrentView && setCurrentView('features')} className="inline-flex items-center gap-2 px-5 py-3 rounded-full bg-gray-100 hover:bg-gray-200 text-gray-800 text-xs sm:text-sm font-bold transition-all cursor-pointer">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 sm:gap-6">
          ...
          <div className="bg-[#FFEBF2] rounded-3xl p-6 border border-pink-200/60 flex flex-col justify-between hover:border-pink-300 transition-colors">
            <div className="text-3xl sm:text-4xl font-bold font-mono text-[#D81B60] mb-2">
              10M+
            </div>
            <div>
              <h4 className="text-xs font-bold text-gray-900 uppercase tracking-wider mb-1">Vision 2030</h4>
              <p className="text-[11px] text-gray-600 leading-relaxed">Target African women reached with trusted health guidance.</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-3xl p-6 border border-gray-200/80 shadow-xs flex flex-col justify-between hover:border-pink-300 transition-colors">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs font-bold text-[#FF4288]">↗</span>
            </div>
            <div className="my-2">
              <div className="text-2xl sm:text-3xl font-bold font-mono text-gray-900">
                1,000+
              </div>
              <h4 className="text-[11px] font-bold text-gray-800 uppercase tracking-wider mt-0.5">Pilot Waitlist</h4>
            </div>
          ...
          <div className="bg-[#FFEBF2] rounded-3xl p-6 border border-pink-200/60 flex flex-col justify-between hover:border-pink-300 transition-colors">
            ...
            <div>
              <h4 className="text-xs font-bold text-gray-900 uppercase tracking-wider mb-1">Years Clinical Obs</h4>
              <p className="text-[11px] text-gray-600 leading-relaxed">Dr. Surayya Zubair & medical partners.</p>
            </div>
          </div>

          <div className="col-span-2 md:col-span-1 bg-gradient-to-br from-[#FF4288] via-[#FF5E93] to-[#D81B60] text-white rounded-3xl p-6 flex flex-col justify-between shadow-lg shadow-pink-500/25">
            ...
            <div className="pt-4">
              <h4 className="text-sm font-bold text-white mb-1">Join VIP Access</h4>
              <p className="text-[11px] text-pink-100 leading-relaxed mb-3">Be first to test Zahera in your community.</p>
      ...
      <section className="max-w-7xl mx-auto px-6 mb-24" id="team">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center px-4 py-1 rounded-full bg-[#FFEBF2] text-[#D81B60] text-xs font-bold uppercase tracking-wider mb-4">
            Our Team
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
          {team.map((m, i) => (
            <div key={i} className="bg-[#FFF5F8] rounded-3xl p-4 sm:p-5 border border-pink-100 shadow-xs hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 flex flex-col justify-between group">
              <div>
                <div className="w-full aspect-[4/4.5] rounded-2xl overflow-hidden bg-pink-200/50 mb-4">
      ...
      <section className="max-w-6xl mx-auto px-6 mb-24" id="traction">
        <div className="bg-white rounded-3xl border border-gray-200/80 p-8 sm:p-12 shadow-lg">
          <div className="flex items-center justify-between flex-wrap gap-4 mb-8">
            <div>
              <span className="inline-flex items-center px-3.5 py-1 rounded-full bg-[#FFEBF2] text-[#D81B60] text-xs font-bold uppercase tracking-wider mb-2">
                Traction & Grants
              </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 rounded-2xl bg-[#FFF5F8] border border-pink-100">
